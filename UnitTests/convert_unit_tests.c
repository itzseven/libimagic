...
ctcase_return_t test_mono_to_gray() {
    ...
    CTAssertEqual(ELT_DATA(gray8, uint8_t, 0), UINT8_MAX);
    CTAssertEqual(ELT_DATA(gray8, uint8_t, 1), 0);
    CTAssertEqual(ELT_DATA(gray8, uint8_t, 2), 0);
    CTAssertEqual(ELT_DATA(gray8, uint8_t, 3), UINT8_MAX);
